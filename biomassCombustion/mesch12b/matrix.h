...
#ifndef maxMesch
#define	maxMesch(a,b)	((a) > (b) ? (a) : (b))
#endif /* max */
#ifndef minMesch
#define	minMesch(a,b)	((a) > (b) ? (b) : (a))
#endif /* min */
...
extern	int m_free(MAT *),v_free(VEC *),px_free(PERM *); // here Boyao add int
...
#define	bd_chk_idx(A,i,j)	((i)>=maxMesch(0,(j)-(A)->ub) && \
		(j)>=maxMesch(0,(i)-(A)->lb) && (i)<(A)->mat->n && (j)<(A)->mat->n)
